...
ax.plot(length, hybrid_recall_t2i, marker='o', label='t2i', color=colors[4], linestyle='-', linewidth=3, markersize=8)
...
ax.legend(['t2i', 'i2t', 'mean'], fontsize=25)
# plt.tight_layout(rect=[0, 0, 1, 0.95])  # 调整整体布局以防止重叠
plt.savefig('flickr_prompt.pdf', format='pdf')

hybrid_recall_t2i = [85.2, 85.8, 85.9, 86.7, 86.2, 86.1, 86.3]
hybrid_recall_i2t = [91.3, 91.2, 91.1, 91.9, 91.3, 91.5, 91.5]
