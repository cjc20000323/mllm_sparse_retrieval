    ...
    def generate_encode_files(self, encoded, jsonl_data, lookup_indices, encode_type, split, is_dspy):
        ...
        if self.training_args.task_typ == 'tbpr':
            if is_dspy:
                ...
                os.makedirs(
                    f'{self.data_args.dense_output_dir}/{self.model_args.model_name_or_path[model_begin_indice:]}/{self.data_args.dataset_name}/image/{filtered}/{self.model_args.calculate_type}/{self.data_args.prompt_type}/{split}/{self.data_args.tbpr_type}/{self.data_args.num_expended_tokens}_{manual}_{self.data_args.sparse_length}_{self.data_args.sparse_value_type}_{cluster}_{self.data_args.reps_loc}_{self.model_args.eol_type}_{self.data_args.sparse_lower_or_upper}_{use_sparse_value_mean}_{self.data_args.prompt_generation_model}_{time_string}',
                    exist_ok=True)
                os.makedirs(
                ...
                with open(os.path.join(
                        f'{self.data_args.sparse_output_dir}/{self.model_args.model_name_or_path[model_begin_indice:]}/{self.data_args.dataset_name}/image/{filtered}/{self.model_args.calculate_type}/{self.data_args.prompt_type}/{split}/{self.data_args.tbpr_type}/{self.data_args.num_expended_tokens}_{manual}_{self.data_args.sparse_length}_{self.data_args.sparse_value_type}_{cluster}_{self.data_args.reps_loc}_{self.model_args.eol_type}_{self.data_args.sparse_lower_or_upper}_{use_sparse_value_mean}_{self.data_args.prompt_generation_model}',
            ...
            if is_dspy:
                time_string = datetime.now().strftime("%Y%m%d_%H%M%S")
                os.makedirs(
                    f'{self.data_args.dense_output_dir}/{self.model_args.model_name_or_path[model_begin_indice:]}/{self.data_args.dataset_name}/{encode_type}/{filtered}/{self.model_args.calculate_type}/{self.data_args.prompt_type}/{split}/{self.data_args.num_expended_tokens}_{manual}_{self.data_args.sparse_length}_{self.data_args.sparse_value_type}_{cluster}_{self.data_args.reps_loc}_{self.model_args.eol_type}_{self.data_args.sparse_lower_or_upper}_{use_sparse_value_mean}_{self.data_args.prompt_generation_model}_{time_string}',
                    exist_ok=True)
                os.makedirs(
                    f'{self.data_args.sparse_output_dir}/{self.model_args.model_name_or_path[model_begin_indice:]}/{self.data_args.dataset_name}/{encode_type}/{filtered}/{self.model_args.calculate_type}/{self.data_args.prompt_type}/{split}/{self.data_args.num_expended_tokens}_{manual}_{self.data_args.sparse_length}_{self.data_args.sparse_value_type}_{cluster}_{self.data_args.reps_loc}_{self.model_args.eol_type}_{self.data_args.sparse_lower_or_upper}_{use_sparse_value_mean}_{self.data_args.prompt_generation_model}_{time_string}',
                    exist_ok=True)
                ...
                os.makedirs(
                    f'{self.data_args.dense_output_dir}/{self.model_args.model_name_or_path[model_begin_indice:]}/{self.data_args.dataset_name}/{encode_type}/{filtered}/{self.model_args.calculate_type}/{self.data_args.prompt_type}/{split}/{self.data_args.num_expended_tokens}_{manual}_{self.data_args.sparse_length}_{self.data_args.sparse_value_type}_{cluster}_{self.data_args.reps_loc}_{self.model_args.eol_type}_{self.data_args.sparse_lower_or_upper}_{use_sparse_value_mean}_{self.data_args.prompt_generation_model}',
                    exist_ok=True)
                os.makedirs(
                    f'{self.data_args.sparse_output_dir}/{self.model_args.model_name_or_path[model_begin_indice:]}/{self.data_args.dataset_name}/{encode_type}/{filtered}/{self.model_args.calculate_type}/{self.data_args.prompt_type}/{split}/{self.data_args.num_expended_tokens}_{manual}_{self.data_args.sparse_length}_{self.data_args.sparse_value_type}_{cluster}_{self.data_args.reps_loc}_{self.model_args.eol_type}_{self.data_args.sparse_lower_or_upper}_{use_sparse_value_mean}_{self.data_args.prompt_generation_model}',
                    exist_ok=True)
...
def dspy_metric(example, pred, trace=None):
    ...
    if training_args.task_type == 'tbpr':
        ...
        dense_output_dir, sparse_output_dir = retrieval_action.generate_encode_files(encoded, jsonl_data, lookup_indices, 'image', 'val', command, True)
        ...
        dense_output_dir, sparse_output_dir = retrieval_action.generate_encode_files(encoded, jsonl_data, lookup_indices, 'text', 'val', command, True)
