...
from template import gme_image_flickr_prompt, gme_text_flickr_prompt, gme_text_coco_prompt, gme_image_coco_prompt, \
    ...
    vlm2vec_query_text_prompt, vlm2vec_query_tbpr_prompt, gme_it2t_prompt, gme_t2it_prompt, lamra_2_t2it_query_prompt, \
    lamra_2_5_t2it_query_prompt, lamra_2_it2t_query_prompt, lamra_2_5_it2t_query_prompt
