...
it2t_retrieval_query_relevant_prompt = llama3_template.format("For the following query and candidate, judge whether they are relevant. Output 'Yes' or 'No'.\nQuery Image and Sentence: <image>\n<sent>\nCandidate Sentence: <sent> Output: ")
...
mistral_it2t_retrieval_query_relevant_prompt = llava_mistral_template.format("For the following query and candidate, judge whether they are relevant. Output 'Yes' or 'No'.\nQuery Image and Sentence: <image>\n<sent>\nCandidate Sentence: <sent> Output: ")
