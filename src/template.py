...
llava_34b_template = '<|im_start|>user\n{}<|im_end|>\n<|im_start|>assistant\n'
llava_34b_template_image_prefix = '<|im_start|>user\n<image>\n'
llava_34b_template_text_prefix = '<|im_start|>user\n<sent>\n'
llava_34b_template_content_element = '<|startoftext|>{}<|im_end|>\n<|im_start|>assistant\n<|endoftext|>'
...
qwen3_template_content_element = '<|box_start|>{}<|im_end|>\n<|im_start|>assistant\n<|box_end|>'
...
gme_image_coco_prompt = 'Identify the image showcasing the described everyday scene.'
gme_text_coco_prompt = 'Find an image caption describing the following everyday image.'
...
lamra_2_5_query_text_prompt = qwen2_5_template.format('Find me an image that matches the given caption.\n<sent>\nSummary above sentence in one word: ')
lamra_2_tbpr_prompt = qwen2_template.format('<|vision_start|><|image_pad|><|vision_end|>\nSummary the person in above image in one word: ')
...
vlm2vec_query_text_prompt = qwen2_template.format('Instruct: Find me an image that matches the given caption.\n Query: <sent>')
vlm2vec_tbpr_prompt = qwen2_template.format('<|image_pad|> Instruct: Represent the given person image.')
vlm2vec_query_tbpr_prompt = qwen2_template.format('Instruct: Find me a person image that matches the given description.\n Query: <sent>')
...
text_reverse_query_relevant_prompt = llama3_template.format("For the following query sentence and candidate image, judge whether they are relevant. Output 'Yes' or 'No'.\nCandidate Image: <image> Query Sentence: <sent> Output: ")
image_reverse_query_relevant_prompt = llama3_template.format("For the following query image and candidate sentence, judge whether they are relevant. Output 'Yes' or 'No'.\nCandidate Sentence: <sent> Query Image: <image> Output: ")
...
mistral_text_reverse_query_relevant_prompt = llava_mistral_template.format("For the following query sentence and candidate image, judge whether they are relevant. Output 'Yes' or 'No'.\nCandidate Image: <image> Query Sentence: <sent> Output: ")
mistral_image_reverse_query_relevant_prompt = llava_mistral_template.format("For the following query image and candidate sentence, judge whether they are relevant. Output 'Yes' or 'No'.\nCandidate Sentence: <sent> Query Image: <image> Output: ")
...
mistral_first_precise_caption_prompt = llava_mistral_template.format("Image: <image>\n Sentence: <sent>\n For the following sentence and image, judge whether the sentence is the precise caption of the image. Output 'Yes' or 'No'. Output: ")
...
qwen2_5_first_precise_caption_prompt = qwen2_5_template.format("Image: <|vision_start|><|image_pad|><|vision_end|>\n Sentence: <sent>\n For the following sentence and image, judge whether the sentence is the precise caption of the image. Output 'Yes' or 'No'. Output: ")
...
qwen3_text_reverse_query_relevant_prompt = qwen3_template.format("For the following query sentence and candidate image, judge whether they are relevant. Output 'Yes' or 'No'.\nCandidate Image: <|vision_start|><|image_pad|><|vision_end|> Query Sentence: <sent> Output: ")
qwen3_image_reverse_query_relevant_prompt = qwen3_template.format("For the following query image and candidate sentence, judge whether they are relevant. Output 'Yes' or 'No'.\nCandidate Sentence: <sent> Query Image: <|vision_start|><|image_pad|><|vision_end|> Output: ")
...
qwen3_first_precise_caption_prompt = qwen3_template.format("Image: <|vision_start|><|image_pad|><|vision_end|>\n Sentence: <sent>\n For the following sentence and image, judge whether the sentence is the precise caption of the image. Output 'Yes' or 'No'. Output: ")
...
person_retrieval_reverse_old_query_relevant_prompt = llama3_template.format("Candidate: <image>\nQuery: <sent>\n Does the candidate answer the query?  Answer 'Yes' or 'No'.  Answer: ")
person_retrieval_reverse_origin_old_query_relevant_prompt = llama3_template.format("Given a candidate and a query, predict whether the candidate includes an answer to the query by producing either ‘Yes‘ or ‘No‘.\nQuery: <sent>\nCandidate: <image>\nDoes the candidate answer the query? Answer: ")
person_retrieval_reverse_query_relevant_prompt = llama3_template.format("For the following query sentence and candidate person image, judge whether they are relevant. Output 'Yes' or 'No'.\nCandidate Person Image: <image> Query Sentence: <sent> Output: ")
person_retrieval_in_one_word_relevant_prompt = llama3_template.format("For the following query sentence and candidate image, judge whether they are relevant. Output 'Yes' or 'No'.\nCandidate Person Image: <image> Query Sentence: <sent> Output in one word: ")
person_retrieval_please_relevant_prompt = llama3_template.format("For the following query sentence and candidate image, judge whether they are relevant. Please output 'Yes' or 'No'.\nCandidate Person Image: <image> Query Sentence: <sent> Output: ")
person_retrieval_precise_caption_prompt = llama3_template.format("For the following query sentence and candidate image, judge whether the sentence is the precise caption of the image. Output 'Yes' or 'No'.\nCandidate Person Image: <image> Query Sentence: <sent> Output: ")
person_retrieval_first_precise_caption_prompt = llama3_template.format("Candidate Person Image: <image>\n Query Sentence: <sent>\n For the following sentence and image, judge whether the sentence is the precise caption of the image. Output 'Yes' or 'No'. Output: ")
person_retrieval_role_relevant_prompt = llama3_template.format("You are RankGPT, an intelligent assistant that can rank candidates based on their relevancy to the query. \n For the following sentence and person image, judge whether they are relevant. Output 'Yes' or 'No'.\nPerson Image: <image> Sentence: <sent> Output: ")
person_retrieval_role_precise_caption_prompt = llama3_template.format("You are RankGPT, an intelligent assistant that can rank candidates based on their relevancy to the query. \n For the following query sentence and candidate person image, judge whether the sentence is the precise caption of the image. Output 'Yes' or 'No'.\nCandidate Person Image: <image> Query Sentence: <sent> Output: ")
person_retrieval_role_old_query_relevant_prompt = llama3_template.format("You are RankGPT, an intelligent assistant that can rank candidates based on their relevancy to the query. \nCandidate: <image>\nQuery: <sent>\n Does the candidate answer the query?  Answer 'Yes' or 'No'.  Answer: ")
...
mistral_person_retrieval_old_query_relevant_prompt = llava_mistral_template.format("Candidate: <image>\nQuery: <sent>\n Does the candidate answer the query?  Answer 'Yes' or 'No'.  Answer: ")
...
mistral_person_retrieval_in_one_word_relevant_prompt = llava_mistral_template.format("For the following query sentence and candidate image, judge whether they are relevant. Output 'Yes' or 'No'.\nCandidate Person Image: <image> Query Sentence: <sent> Output in one word: ")
mistral_person_retrieval_please_relevant_prompt = llava_mistral_template.format("For the following query sentence and candidate image, judge whether they are relevant. Please output 'Yes' or 'No'.\nCandidate Person Image: <image> Query Sentence: <sent> Output: ")
mistral_person_retrieval_precise_caption_prompt = llava_mistral_template.format("For the following query sentence and candidate image, judge whether the sentence is the precise caption of the image. Output 'Yes' or 'No'.\nCandidate Person Image: <image> Query Sentence: <sent> Output: ")
mistral_person_retrieval_first_precise_caption_prompt = llava_mistral_template.format("Candidate Person Image: <image>\n Query Sentence: <sent>\n For the following sentence and image, judge whether the sentence is the precise caption of the image. Output 'Yes' or 'No'. Output: ")
mistral_person_retrieval_role_relevant_prompt = llava_mistral_template.format("You are RankGPT, an intelligent assistant that can rank candidates based on their relevancy to the query. \n For the following sentence and person image, judge whether they are relevant. Output 'Yes' or 'No'.\nPerson Image: <image> Sentence: <sent> Output: ")
mistral_person_retrieval_role_precise_caption_prompt = llava_mistral_template.format("You are RankGPT, an intelligent assistant that can rank candidates based on their relevancy to the query. \n For the following query sentence and candidate person image, judge whether the sentence is the precise caption of the image. Output 'Yes' or 'No'.\nCandidate Person Image: <image> Query Sentence: <sent> Output: ")
mistral_person_retrieval_role_old_query_relevant_prompt = llava_mistral_template.format("You are RankGPT, an intelligent assistant that can rank candidates based on their relevancy to the query. \nCandidate: <image>\nQuery: <sent>\n Does the candidate answer the query?  Answer 'Yes' or 'No'.  Answer: ")
...
mistral_t2it_retrieval_query_relevant_prompt = llava_mistral_template.format("For the following query sentence and candidate image and sentence, judge whether they are relevant. Output 'Yes' or 'No'.\nCandidate Image and Sentence: <sent> <image> Query Sentence: <sent> Output: ")
mistral_t2it_retrieval_origin_old_query_relevant_prompt = llava_mistral_template.format("Given a candidate and a query, predict whether the candidate includes an answer to the query by producing either ‘Yes‘ or ‘No‘.\nCandidate Image and Sentence: <image>\n<sent>\nQuery: <sent>\nDoes the candidate answer the query? Answer: ")
it2t_retrieval_old_query_relevant_prompt = llama3_template.format("Query image and text: <image>\n<sent>\nCandidate: <sent>\n Does the candidate image and text answer the query text?  Answer 'Yes' or 'No'.  Answer: ")
it2t_retrieval_query_relevant_prompt = llama3_template.format("For the following query image and sentence and candidate sentence, judge whether they are relevant. Output 'Yes' or 'No'.\nQuery Image and Sentence: <image> <sent> Candidate Sentence: <sent> Output: ")
...
it2t_retrieval_answer_relevant_prompt = llama3_template.format("For the following query and candidate, judge whether the candidate is the best answer of the query. Output 'Yes' or 'No'.\nQuery Image and Sentence: <image>\n<sent>\nCandidate Sentence: <sent> Output: ")
...
retrieval_disassemble_text_prompts_person_retrieval_2_for_concat = [
    'Summary the gender of person in above sentence in one word: ',
    'Summary the actions or movements of person in above sentence in one word: ',
]

retrieval_disassemble_text_prompts_person_retrieval_3_for_concat = [
    'Summary the gender of person in above sentence in one word: ',
    'Summary the actions or movements of person in above sentence in one word: ',
    'Summary the objects in above sentence in one word: ',
]

retrieval_disassemble_text_prompts_person_retrieval_4_for_concat = [
    'Summary the gender of person in above sentence in one word: ',
    'Summary the actions or movements of person in above sentence in one word: ',
    'Summary the objects in above sentence in one word: ',
    'Summary the wearing of person in above sentence in one word: ',
...
retrieval_disassemble_text_prompts_person_retrieval_6_for_concat = [
    'Summary the gender of person in above sentence in one word: ',
    'Summary the actions or movements of person in above sentence in one word: ',
    'Summary the objects in above sentence in one word: ',
    'Summary the wearing of person in above sentence in one word: ',
