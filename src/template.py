...
lamra_2_query_tbpr_prompt = qwen2_template.format('Find me a person image that matches the given description.\n<sent>\nSummary the person in above image and sentence in one word: ')
lamra_2_5_query_tbpr_prompt = qwen2_5_template.format('Find me a person image that matches the given description.\n<sent>\nSummary the person in above image and sentence in one word: ')
vlm2vec_img_prompt = qwen2_template.format()
vlm2vec_text_prompt = qwen2_template.format()
vlm2vec_query_img_prompt = qwen2_template.format()
vlm2vec_query_text_prompt = qwen2_template.format()
vlm2vec_tbpr_prompt = qwen2_template.format()
vlm2vec_query_tbpr_prompt = qwen2_template.format()
